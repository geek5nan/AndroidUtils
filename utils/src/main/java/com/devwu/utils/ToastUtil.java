...
public class ToastUtil {
    ...
    private static void showToast(String toastStr, int length) {
        if (checkText(toastStr)) {
            Toast.makeText(AppUtil.getApplicationContext(), toastStr, length).show();
        }
    }

    private static void showToast(int id, int length) {
        if (checkText(AppUtil.getApplicationContext().getString(id))) {
            Toast.makeText(AppUtil.getApplicationContext(), id, length).show();
        }
    }
